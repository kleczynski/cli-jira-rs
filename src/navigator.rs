    ...
    pub fn handle_action(&mut self, action: Action) -> Result<()> {
        match action {
            ...
            Action::DeleteEpic { epic_id } => {
                let user_decision = (self.prompts.delete_epic)();
                if user_decision {
                    self.db
                        .delete_epic(epic_id)
            ...
            Action::DeleteStory { epic_id, story_id } => {
                let user_decision = (self.prompts.delete_story)();
